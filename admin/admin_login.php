                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user"  action="admin_login.php" method="POST" >
                                        <div class="form-group">
                                            <input type="email" name="uemail" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="pswd" class="form-control form-control-user"
                                                id="exampleInputPassword"  onkeyup = "Validate(this)" placeholder="Password">
                                        </div>
