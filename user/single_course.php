                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                    <div class="curriculam-cont">
                                        <div class="title">
                                            <h6> <?php echo $row['cname']; ?> Started</h6>
                                        </div>
                                                ...
                                                <div class="card-header" id="headingOne">
                                                    <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is  <?php echo $row['cname']; ?></span></li>
                                                ...
                                                <div class="card-header" id="headingThree">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <ul>
                                                            ...
                                                            <li><span class="head"> <?php echo $row['cname']; ?></span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-6">
                <div class="course-features mt-30">
                 ...
                 <ul>
                    <li><i class="fa fa-clock-o"></i>Duaration : <span> <?php echo $row['cdur']; ?> month</span></li>
                    <li><i class="fa fa-clone"></i>Leactures : <span>09</span></li>
                    <li><i class="fa fa-beer"></i>Quizzes :  <span>05</span></li>

                </ul>
                <div class="price-button pt-10">
                    <span>Price : <b><?php echo "&#8377 ".$row['cfees']; ?></b></span>
                    <?php 
                                      // $cid=$row['cid'];
                    $uid=$_SESSION['uid'];
                    $uid1=0;
                   ...
                   if($uid1==$uid){ ?>
                    <form action="unenroll_course.php" method="POST">
                  <button value=" <?php echo $cid; ?>" name="submit" class="main-btn">  UnEnroll </button></form>
                    <?php
                }
                else{ ?>
                    <form action="enroll_course.php" method="POST">
                  <button value=" <?php echo $cid; ?>" name="submit" class="main-btn">  Enroll Now</button></form>
                    <?php
                }
